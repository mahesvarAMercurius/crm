...
<script type="text/javascript">
	$(function(){
		...
		$("#activitySourceBtn").click(function () {
			$("#activitySearchName").val("");
			$("#activitySearchBody").html("");
			$("#searchActivityModal").modal("show");
		})

		//为搜索市场活动文本框绑定事件
		$("#activitySearchName").keydown(function (event) {
			if(event.keyCode == 13){
				$.ajax({
					url:"workbench/clue/getActivityListByName.do",
					data:{
						"name":$.trim($("#activitySearchName").val())
					},
					type:"get",
					dataType:"json",
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="activitySearchName" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
