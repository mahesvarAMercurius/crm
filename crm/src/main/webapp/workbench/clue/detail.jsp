	...
	$(function(){
        ...
        $("#relationBtn").click(function () {
			...
			for(var i = 0;i<$xz.length;i++){
				param += "activityId="+$xz.get(i).value;
				if(i<$xz.length-1){
					param += "&";
				}
			}
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${requestScope.c.fullname}${requestScope.c.appellation} <small>${requestScope.c.company}</small></h3>
		</div>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="relationActivityBtn" <%--data-toggle="modal" data-target="#bundModal"--%> style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
