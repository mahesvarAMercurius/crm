	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="tranForm" action="workbench/transaction/save.do" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-clueSource" name="source">
				  <option></option>
					<c:forEach items="${applicationScope.source}" var="v">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="腾讯大王卡">
				<input type="hidden" value="4d8bd832bd544582be5407f034af7eee" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="02de6396b2ff4c19aa9260a68a1341f9" name="contactsId"/>
			</div>
		</div>
